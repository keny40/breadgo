...
const planCards = [
  ...
  },
  {
    ...
    features: ["수율 대시보드", "반복 상품 등록", "요일별 템플릿", "CSV 일괄 등록", "재고 변경 이력", "재고 이상 감지", "ESG 리포트", "추천 재고/할인가", "고객 전환 분석", "주간 리포트 Export"],
    cta: "현재 MVP 기본 플랜",
  },
  {
    key: "ENTERPRISE",
    name: "Enterprise",
    badge: "Enterprise",
    description: "다중 매장/프랜차이즈 운영과 POS Provider Adapter 확장을 위한 플랜입니다.",
    features: ["매장 통합 대시보드", "프랜차이즈/본사 리포트", "CSV 일괄 등록 고도화", "POS Provider Adapter 준비", "전담 운영 리포트"],
    cta: "도입 문의 준비 중",
  },
];
...
const featureLabels: Record<keyof MerchantProPlan["features"], string> = {
  ...
  inventory_ledger: "Inventory Ledger / 재고 변경 이력",
  inventory_alerts: "재고 이상 감지 / 운영 알림",
  esg_report: "ESG 리포트",
  recommendations: "추천 재고/할인",
  recommendation_performance: "추천 성과 분석",
  product_funnel: "고객 전환 퍼널",
  multi_store_dashboard: "다중 매장 통합",
  pos_api_integration: "POS Provider Adapter / API 연동 준비",
};
